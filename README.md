...
**免费在线工具 · 数据本地处理不上传**。股票涨跌停板计算器、人民币大写转换、证件照尺寸对照表、半角全角转换、汉字简繁转换等 22 个工具，全程在浏览器本地运行，不产生任何数据上传，打开即用。
...
| [JWT 密钥生成器](jwtsecret.html) | 加密级随机生成 JWT 签名密钥，支持 Base64 / Base64URL / Hex |
...
| [字数统计工具](wordcount.html) | 实时统计汉字、英文单词、标点、数字、字符等 |
